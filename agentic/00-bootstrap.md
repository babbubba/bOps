...
V1.1-F, the read-only plugin catalog API and UI. The remaining ordered V1.1 batches and all later
gates are defined only by the consolidated roadmap. V1.2 multi-agent work is not in scope until the
complete V1.1-H gate closes.
