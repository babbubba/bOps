...
V1.1-G, writable Settings backed by an encrypted local vault. The remaining ordered V1.1 batches and
all later gates are defined only by the consolidated roadmap. V1.2 multi-agent work is not in scope
