...
multi-agent orchestration; its design is ADR-0030 and its sub-tasks A–M are listed in the V1.2 task (A–M are implemented; the gate is closed). All gates are defined only by the
