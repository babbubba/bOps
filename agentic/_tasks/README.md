...
| 9 | [`V1.2 multi-agent`](2026-09-16-v1.2-multi-agent.md) | **Active — A to I implemented (C1 to C3, the orchestrator, its budgets, durable state, separation of duties, audit provenance and the CLI), J next**; sub-tasks A–M | molto alto, split A–M |
