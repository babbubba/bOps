...
| 9 | [`V1.2 multi-agent`](2026-09-16-v1.2-multi-agent.md) | **Active — A to G implemented (C1 to C3, the orchestrator, its budgets, durable state and separation of duties), H next**; sub-tasks A–M | molto alto, split A–M |
