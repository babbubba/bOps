...
internal static class WindowsFirewallCollector
{
    ...
    internal static string Direction(int v)=>v==1?"inbound":v==2?"outbound":"unknown"; internal static string Action(int v)=>v==1?"block":v==0?"allow":"unknown"; private static string Inbound(int v)=>Action(v); internal static string Protocol(int v)=>v==6?"tcp":v==17?"udp":v is 1 or 58?"icmp":v==256?"any":"native-unknown";
