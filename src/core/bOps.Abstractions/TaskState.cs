...
public sealed record PlanStep
{
    ...
    public PlanStep(int Index, string? Description, ModelToolCall? ToolCall, ToolCallResult? Result, string? Observation)
    {
        this.Index = Index;
...
public sealed record TaskState
{
    ...
    public TaskState(Guid Id, NodeId Node, string Goal, AgentTaskStatus Status, IReadOnlyList<PlanStep> Steps, DateTimeOffset CreatedAtUtc)
    {
        this.Id = Id;
        this.Node = Node;
        this.Goal = Goal;
