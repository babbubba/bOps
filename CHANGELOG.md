...
- ADR-0031 (Proposed) amends ADR-0030 §3 with a per-role table of required, optional and not-applicable
  envelope dimensions, and D-027 records the operator's three choices. Documentation only; no behaviour
  changes until it is accepted and V1.2-C implements it.
